...
#SBATCH --job-name=Sequential-Object-Weight-L1SP-50-ConAbl
...
#SBATCH --output=logs/Sequential/Object/Weight/L1SP/50/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Object/Weight/L1SP/50/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Object Unlearning with Weight L1SP 50 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L1SP/50/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L1SP/50/ConAbl/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Weight L1SP 50 ConAbl finished!"
