#!/bin/bash
#SBATCH --job-name=Sequential-Object-Weight-L1SP-100-SculpMem
...
echo "Sequential Object Unlearning with Weight L1SP 100 SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L1SP/100/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L1SP/100/SculpMem/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Weight L1SP 100 SculpMem finished!"
