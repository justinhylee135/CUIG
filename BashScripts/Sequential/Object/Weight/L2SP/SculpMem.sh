#!/bin/bash
#SBATCH --job-name=Sequential-Object-Weight-L2SP-25000-SculpMem
...
echo "Sequential Object Unlearning with Weight L2SP 25000 SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L2SP/25000/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L2SP/25000/SculpMem/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Weight L2SP 25000 SculpMem finished!"
