...
#SBATCH --job-name=Sequential-Object-Weight-L2SP-25000-ConAbl
...
#SBATCH --output=logs/Sequential/Object/Weight/L2SP/25000/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Object/Weight/L2SP/25000/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Object Unlearning with Weight L2SP 25000 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L2SP/25000/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Weight/L2SP/25000/ConAbl/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Weight L2SP 25000 ConAbl finished!"
