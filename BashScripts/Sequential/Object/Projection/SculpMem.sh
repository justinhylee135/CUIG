#!/bin/bash
#SBATCH --job-name=Sequential-Object-Projection-200-SculpMem
...
echo "Sequential Object Unlearning with Projection 200 SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Projection/200/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Projection/200/SculpMem/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Projection 200 SculpMem finished!"
