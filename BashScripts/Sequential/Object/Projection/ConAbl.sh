...
#SBATCH --job-name=Sequential-Object-Projection-200-ConAbl
...
#SBATCH --output=logs/Sequential/Object/Projection/200/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Object/Projection/200/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Object Unlearning with Projection 200 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Projection/200/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Projection/200/ConAbl/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Projection 200 ConAbl finished!"
