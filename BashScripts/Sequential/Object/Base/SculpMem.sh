#!/bin/bash
#SBATCH --job-name=Sequential-Object-Base-SculpMem
...
echo "Sequential Object Unlearning with Base SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/Base/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/Base/SculpMem/Results"
iterations=2000
...
echo "Sequential Object Unlearning with Base SculpMem finished!"
