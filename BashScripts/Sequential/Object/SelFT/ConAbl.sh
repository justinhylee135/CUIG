...
#SBATCH --job-name=Sequential-Object-SelFT-0.05-ConAbl
...
#SBATCH --output=logs/Sequential/Object/SelFT/0.05/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Object/SelFT/0.05/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Object Unlearning with SelFT 0.05 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Object/SelFT/0.05/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Object/SelFT/0.05/ConAbl/Results"
iterations=2000
...
echo "Sequential Object Unlearning with SelFT 0.05 ConAbl finished!"
