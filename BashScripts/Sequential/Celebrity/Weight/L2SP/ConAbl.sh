#!/bin/bash
#SBATCH --job-name=Sequential-Celebrity-Weight-L2SP-100-ConAbl
...
echo "Sequential Celebrity Unlearning with Weight L2SP 100 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Celebrity/Weight/L2SP/100/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Celebrity/Weight/L2SP/100/ConAbl/Results"
...
mkdir -p "${REPO_ROOT}/logs/Sequential/Celebrity/Weight/L2SP/100/ConAbl" "${prompt_dir}" "${prompt_locks_dir}"
...
for celeb in "${unlearn_celebrities[@]}"; do
    ...
    echo "Completed Sequential Celebrity Unlearning with Weight L2SP 100 ConAbl through celebrity: ${celeb}"
done

echo "Sequential Celebrity Unlearning with Weight L2SP 100 ConAbl finished!"
