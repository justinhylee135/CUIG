#!/bin/bash
#SBATCH --job-name=Sequential-Celebrity-Weight-L1SP-0.10-ConAbl
...
echo "Sequential Celebrity Unlearning with Weight L1SP 0.10 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Celebrity/Weight/L1SP/0.10/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Celebrity/Weight/L1SP/0.10/ConAbl/Results"
...
mkdir -p "${REPO_ROOT}/logs/Sequential/Celebrity/Weight/L1SP/0.10/ConAbl" "${prompt_dir}" "${prompt_locks_dir}"
...
for celeb in "${unlearn_celebrities[@]}"; do
    ...
    echo "Completed Sequential Celebrity Unlearning with Weight L1SP 0.10 ConAbl through celebrity: ${celeb}"
done

echo "Sequential Celebrity Unlearning with Weight L1SP 0.10 ConAbl finished!"
