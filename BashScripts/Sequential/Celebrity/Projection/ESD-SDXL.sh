#!/bin/bash
#SBATCH --job-name=Sequential-Celebrity-Projection-200-ESD-SDXL
...
echo "Sequential Celebrity Unlearning with Projection 200 ESD-SDXL starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Celebrity/Projection/200/ESD-SDXL/Models"
results_root="${OUTPUT_ROOT}/Sequential/Celebrity/Projection/200/ESD-SDXL/Results"
...
mkdir -p "${REPO_ROOT}/logs/Sequential/Celebrity/Projection/200/ESD-SDXL" "${prompt_dir}" "${prompt_locks_dir}"
...
for celeb in "${unlearn_celebrities[@]}"; do
    ...
    previously_unlearned_json="$(array_to_json "${unlearned[@]}")"
    ...
    echo "Completed Sequential Celebrity Unlearning with Projection 200 ESD-SDXL through celebrity: ${celeb}"
done

echo "Sequential Celebrity Unlearning with Projection 200 ESD-SDXL finished!"
