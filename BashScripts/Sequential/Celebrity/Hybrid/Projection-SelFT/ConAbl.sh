#!/bin/bash
#SBATCH --job-name=Sequential-Celebrity-Hybrid-Projection_SelFT-200_0.10-ConAbl
...
echo "Sequential Celebrity Unlearning with Hybrid Projection_SelFT 200_0.10 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Celebrity/Hybrid/Projection_SelFT/200_0.10/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Celebrity/Hybrid/Projection_SelFT/200_0.10/ConAbl/Results"
...
mkdir -p "${REPO_ROOT}/logs/Sequential/Celebrity/Hybrid/Projection_SelFT/200_0.10/ConAbl" "${prompt_dir}" "${prompt_locks_dir}"
...
for celeb in "${unlearn_celebrities[@]}"; do
    ...
    echo "Completed Sequential Celebrity Unlearning with Hybrid Projection_SelFT 200_0.10 ConAbl through celebrity: ${celeb}"
done

echo "Sequential Celebrity Unlearning with Hybrid Projection_SelFT 200_0.10 ConAbl finished!"
