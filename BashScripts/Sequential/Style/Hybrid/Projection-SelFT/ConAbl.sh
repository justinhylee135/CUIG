...
#SBATCH --job-name=Sequential-Style-Hybrid-Projection_SelFT-200_0.30-ConAbl
...
#SBATCH --output=logs/Sequential/Style/Hybrid/Projection_SelFT/200_0.30/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Style/Hybrid/Projection_SelFT/200_0.30/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Style Unlearning with Hybrid Projection_SelFT 200_0.30 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Hybrid/Projection_SelFT/200_0.30/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Hybrid/Projection_SelFT/200_0.30/ConAbl/Results"
...
echo "Sequential Style Unlearning with Hybrid Projection_SelFT 200_0.30 ConAbl finished!"
