...
#SBATCH --job-name=Sequential-Style-Weight-L1SP-50-ConAbl
...
#SBATCH --output=logs/Sequential/Style/Weight/L1SP/50/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Style/Weight/L1SP/50/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Style Unlearning with Weight L1SP 50 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L1SP/50/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L1SP/50/ConAbl/Results"
...
echo "Sequential Style Unlearning with Weight L1SP 50 ConAbl finished!"
