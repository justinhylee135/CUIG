#!/bin/bash
#SBATCH --job-name=Sequential-Style-Weight-L1SP-10-SculpMem
...
echo "Sequential Style Unlearning with Weight L1SP 10 SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L1SP/10/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L1SP/10/SculpMem/Results"
...
echo "Sequential Style Unlearning with Weight L1SP 10 SculpMem finished!"
