#!/bin/bash
#SBATCH --job-name=Sequential-Style-Weight-L2SP-25000-SculpMem
...
echo "Sequential Style Unlearning with Weight L2SP 25000 SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L2SP/25000/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Weight/L2SP/25000/SculpMem/Results"
...
echo "Sequential Style Unlearning with Weight L2SP 25000 SculpMem finished!"
