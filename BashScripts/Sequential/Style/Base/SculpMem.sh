#!/bin/bash
#SBATCH --job-name=Sequential-Style-Base-SculpMem
...
echo "Sequential Style Unlearning with Base SculpMem starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Base/SculpMem/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Base/SculpMem/Results"
...
echo "Sequential Style Unlearning with Base SculpMem finished!"
