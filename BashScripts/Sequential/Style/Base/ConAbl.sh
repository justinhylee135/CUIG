...
#SBATCH --job-name=Sequential-Style-Base-ConAbl
...
#SBATCH --output=logs/Sequential/Style/Base/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Style/Base/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Style Unlearning with Base ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Base/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Base/ConAbl/Results"
...
echo "Sequential Style Unlearning with Base ConAbl finished!"
