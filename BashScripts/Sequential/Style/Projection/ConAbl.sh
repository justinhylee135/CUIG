...
#SBATCH --job-name=Sequential-Style-Projection-200-ConAbl
...
#SBATCH --output=logs/Sequential/Style/Projection/200/ConAbl_%j.out
#SBATCH --error=logs/Sequential/Style/Projection/200/ConAbl_%j.err

# Script settings
source ~/.bashrc
set -euo pipefail

echo "Sequential Style Unlearning with Projection 200 ConAbl starting..."
...
models_root="${OUTPUT_ROOT}/Sequential/Style/Projection/200/ConAbl/Models"
results_root="${OUTPUT_ROOT}/Sequential/Style/Projection/200/ConAbl/Results"
...
echo "Sequential Style Unlearning with Projection 200 ConAbl finished!"
