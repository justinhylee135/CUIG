...
```bash
python sample.py \
--unet_ckpt_path /fs/scratch/PAS2099/lee.10369/CUIG/ca/models/independent/base/object/Bears_test/delta.bin \
--output_dir /fs/scratch/PAS2099/lee.10369/CUIG/ca/eval_results/independent/base/object/Bears_test/images \
