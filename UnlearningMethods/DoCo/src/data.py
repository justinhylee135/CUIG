...
def setup_data_and_scheduler(args, tokenizer, accelerator, optimizer, optimizer_D):
    """
    ...
    print(f"\tUsing lr scheduler: '{args.lr_scheduler}' with warmup steps: '{args.lr_warmup_steps}'")
    ...
    return train_dataloader, lr_scheduler, lr_scheduler_D