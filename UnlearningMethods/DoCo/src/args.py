...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        '--num_denoise_steps',
        help='Number of denoising steps for unlearning and retaining',
        type=int,
        default=1
    )
    parser.add_argument(
        '--use_random_latent',
        action='store_true',
        help='Use random latent for discriminator training',
        default=False
    )
    parser.add_argument(
        '--num_timesteps',
        help='Number of timesteps for denoising',
        type=int,
        default=999
    )
    parser.add_argument(
        '--discrim_pixel_space',
        action='store_true',
        help='train discriminator in pixel space',
        default=False
    )
    parser.add_argument(
        '--discrim_model',
    ...
    parser.add_argument(
        '--gradient_clip',
        help='orthogonalize gradient for unlearn and retain',
        action='store_true',
        default=False
    )
    parser.add_argument(
        '--discrim_num_warmup_steps',
        help='Number of warmup steps for discriminator',
        type=int,
        default=500
    )
    parser.add_argument(
